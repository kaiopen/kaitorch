...
from ...attribute import Timestamp, XYZ


class PointCloudXYZTime(XYZ, Timestamp):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(xyzf=xyzf, timestamp=timestamp, *args, **kwargs)

    def __getitem__(self, i: Union[int, slice, Sequence[Union[int, bool]]]):
        return self.__class__(xyzf=self.xyz_[i], timestamp=self.timestamp_[i])
    ...
    def append_(
        ...
        *args, **kwargs
        ...
        '''
        return super().append_(xyzf=xyzf, timestamp=timestamp, *args, **kwargs)
    ...
    def copy(self):
        ...
        '''
        return self.__class__(xyzf=self.xyz, timestamp=self.timestamp)
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(xyzf=obj.xyz_, timestamp=obj.timestamp_)
