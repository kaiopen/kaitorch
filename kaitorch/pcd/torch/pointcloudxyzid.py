...
from ...attribute import ID, XYZ


class PointCloudXYZID(XYZ, ID):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(xyzf=xyzf, id=id, *args, **kwargs)

    def __getitem__(self, i: Union[int, slice, Sequence[Union[int, bool]]]):
        return self.__class__(xyzf=self.xyz_[i], id=self.id_[i])
    ...
    def append_(
        ...
        *args, **kwargs
        ...
        '''
        return super().append_(xyzf=xyzf, id=id, *args, **kwargs)
    ...
    def copy(self):
        ...
        '''
        return self.__class__(xyzf=self.xyz, id=self.id)
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(xyzf=obj.xyz_, id=obj.id_)
