...
from ...attribute import ID, Ring, Timestamp, XYZ


class PointCloudXYZRTimeID(XYZ, Ring, Timestamp, ID):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            xyzf=xyzf, ring=ring, timestamp=timestamp, id=id, *args, **kwargs
        )
    ...
    def copy(self):
        ...
        '''
        return self.__class__(
            xyzf=self.xyz, ring=self.ring, timestamp=self.timestamp, id=self.id
        )
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(
            xyzf=obj.xyz_, ring=obj.ring_, timestamp=obj.timestamp_, id=obj.id_
        )
