...
from ...attribute import Intensity, Ring, Timestamp, XYZ


class PointCloudXYZIRTime(XYZ, Intensity, Ring, Timestamp):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            xyzf=xyzf, intensity=intensity, ring=ring, timestamp=timestamp,
            *args, **kwargs
        )
