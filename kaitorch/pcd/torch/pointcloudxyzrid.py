...
from ...attribute import ID, Ring, XYZ


class PointCloudXYZRID(XYZ, Ring, ID):
    def __init__(
        self,
        ...
        *args, **kwargs
        ...
        '''
        super().__init__(xyzf=xyzf, ring=ring, id=id, *args, **kwargs)
    ...
    def append_(
        ...
        *args, **kwargs
        ...
        '''
        return super().append_(xyzf=xyzf, ring=ring, id=id, *args, **kwargs)
    ...
    def copy(self):
        ...
        '''
        return self.__class__(xyzf=self.xyz, ring=self.ring, id=self.id)
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(xyzf=obj.xyz_, ring=obj.ring_, id=obj.id_)
