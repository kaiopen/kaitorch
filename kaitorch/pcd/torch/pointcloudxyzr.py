...
from ...attribute import Ring, XYZ


class PointCloudXYZR(XYZ, Ring):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(xyzf=xyzf, ring=ring, *args, **kwargs)

    def __getitem__(self, i: Union[int, slice, Sequence[Union[int, bool]]]):
        return self.__class__(xyzf=self.xyz_[i], ring=self.ring_[i])
    ...
    def append_(
        ...
        *args, **kwargs
        ...
        '''
        return super().append_(xyzf=xyzf, ring=ring, *args, **kwargs)
    ...
    def copy(self):
        ...
        '''
        return self.__class__(xyzf=self.xyz, ring=self.ring)
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(xyzf=obj.xyz_, ring=obj.ring_)
