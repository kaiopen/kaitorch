...
from ...attribute import ID, Intensity, Ring, XYZ


class PointCloudXYZIRID(XYZ, Intensity, Ring, ID):
    r'''
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            xyzf=xyzf, intensity=intensity, ring=ring, id=id, *args, **kwargs
        )
    ...
    def copy(self):
        ...
        '''
        return self.__class__(
            xyzf=self.xyz, intensity=self.intensity, ring=self.ring, id=self.id
        )
    ...
    def from_similar(cls, obj):
        ...
        '''
        return cls(
            xyzf=obj.xyz_, intensity=obj.intensity_, ring=obj.ring_, id=obj.id_
        )
